...
5. Primer quality was evaluated based on Tm, GC content, self-complementarity, and product size.
...
All analyses were performed using publicly available bioinformatics tools from NCBI.
